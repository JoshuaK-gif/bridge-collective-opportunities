        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-blue-600" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>{page_title}</h1>
            </div>
                ...
                return (
                  <motion.div key={i} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }} className={`${bg} rounded-xl p-5 border border-gray-100`}>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-lg text-gray-900" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>{tip.title}</h3>
                        <p className="text-base text-gray-600 mt-1 leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>{tip.desc}</p>
                      </div>
                    </div>
                  </motion.div>
                );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <h2 className="font-bold text-lg flex items-center gap-2 mb-4 text-green-700" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
                  <CheckCircle2 className="w-4 h-4" /> Do
                </h2>
                <ul className="space-y-2.5">
                  {dos.map((item, i) => (
                    <li key={i} className="flex items-start gap-2 text-lg text-gray-700" style={{ fontFamily: 'Inter, sans-serif' }}>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
                <h2 className="font-bold text-lg flex items-center gap-2 mb-4 text-red-700" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
            ...
            <div className="mt-8 text-center bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-8 border border-primary/20">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>Ready to Build Your CV?</h2>
              <p className="text-lg text-gray-600 mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>Use our free CV builder to create a professional CV in minutes.</p>
