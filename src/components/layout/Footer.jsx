  ...
  return (
    <footer className="border-t bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 py-10 text-center">
        <img src="/BCO.png" alt="BCO" className="h-16 md:h-24 w-auto mx-auto mb-2" />
        ...
        <div className="flex justify-center gap-3 mb-6 flex-wrap">
          {socials.map(s => (
            <a
              ...
              title={s.name}
              className="w-10 h-10 rounded-full bg-muted flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all hover:-translate-y-0.5"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">{s.svg}</svg>
            </a>
          ))}
        </div>
